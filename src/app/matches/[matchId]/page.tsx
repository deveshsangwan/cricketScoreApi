...
export default function MatchDetailsPage() {
  ...
  // Reusable card component with updated styling to match the design
  const InfoCard = ({ title, children, className = '' }: { title: string, children: React.ReactNode, className?: string }) => (
    <div className={`bg-[#142D3B] border border-[#234354] rounded-2xl p-6 shadow-xl flex flex-col ${className}`}>
                ...
                <div className="flex items-center justify-between gap-4 p-4 rounded-lg bg-slate-900/50">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {matchStats.team1.overs !== undefined && (
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-extrabold text-white">
                      {matchStats.team1.score !== undefined ? matchStats.team1.score : '0'}
                      {matchStats.team1.wickets !== undefined && `/${matchStats.team1.wickets}`}
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-1">
                  {matchStats.runRate.currentRunRate !== undefined && (
                    <div className="flex justify-between items-center">
                      ...
                      <p className="text-xl font-extrabold text-green-400">{matchStats.runRate.currentRunRate}</p>
                    </div>
                  )}
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  {matchStats.summary && (
                    <li className="flex items-center gap-3">
                      ...
                      <span className="text-slate-300">{matchStats.summary}</span>
                    </li>
                  )}
                </ul>
              </div>
