                  ...
                  {Object.entries(matchStats.keyStats).map(([key, value]) => (
                    <div key={key} className="space-y-2">
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-slate-800/70 flex items-center justify-center text-slate-400 mt-0.5 flex-shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm font-semibold text-slate-300 leading-relaxed break-words">
                            {value}
                          </p>
                        </div>
                      </div>
