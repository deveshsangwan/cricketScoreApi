...
export default function Navbar() {
  return (
    <nav className="shadow-xl bg-card/40 backdrop-blur-lg border-b-2 border-border/60 sticky top-0 z-50 before:absolute before:inset-0 before:bg-gradient-to-r before:from-card/50 before:to-card/30 before:backdrop-blur-sm before:-z-10"> 
