...
exports.matchStatsResponseSchema = exports.commentaryDataSchema = exports.runRateDataSchema = exports.playerDataSchema = exports.iTeamDataSchema = exports.iPreviousInningsSchema = exports.liveMatchesResponseSchema = exports.matchStatsParamsSchema = void 0;
...
exports.runRateDataSchema = zod_1.z.object({
    currentRunRate: zod_1.z.number(),
    requiredRunRate: zod_1.z.number(),
});
exports.commentaryDataSchema = zod_1.z.object({
    over: zod_1.z.string().optional(),
    commentary: zod_1.z.string(),
    hasOver: zod_1.z.boolean(),
});
exports.matchStatsResponseSchema = zod_1.z.object({
    ...
    runRate: exports.runRateDataSchema.optional(),
